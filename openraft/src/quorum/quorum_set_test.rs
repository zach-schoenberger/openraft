...
fn test_ids() -> anyhow::Result<()> {
    {
        ...
        assert_eq!(btreeset! {1,2,3,4,5}, m12345.ids().collect::<std::collections::BTreeSet<_>>());
    }
...

    {
        ...
        assert_eq!(btreeset! {1,2,3,4,5,6,7,8}, qs.ids().collect::<std::collections::BTreeSet<_>>());
    }
